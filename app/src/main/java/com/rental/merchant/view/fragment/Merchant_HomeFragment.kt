...
class Merchant_HomeFragment : Fragment(), RecyclerViewItemClick {
    private lateinit var merchant_homeViewModel: Merchant_Dash_ViewModel
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        merchant_homeViewModel = ViewModelProviders.of(this).get(Merchant_Dash_ViewModel::class.java)
