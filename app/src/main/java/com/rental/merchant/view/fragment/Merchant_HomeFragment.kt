...
class Merchant_HomeFragment : Fragment(), RecyclerViewItemClick {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        merchant_homeViewModel.getmerchantHomeOrderList().observe(this, Observer {
            merchant_rec_veichle.adapter = HomeAdapter(it.order_listing as ArrayList<Data>, requireActivity(), this)
