...
class AgentAssignMerchantAdapter (val orderListing: MutableList<Order_listing>, val context: Context) : RecyclerView.Adapter<AgentAssignMerchantAdapter.CardViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AgentAssignMerchantAdapter.CardViewHolder {
        val card_view = AgentAssignMerchantAdapter.CardViewHolder(
    ...
    override fun onBindViewHolder(holder: AgentAssignMerchantAdapter.CardViewHolder, position: Int) {
