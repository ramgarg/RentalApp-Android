...
/*
class MerchantOrderStatusAdapter (val items: List<CustomerOrderListResModelItem>, override  val context: Context, override val infalterBinderInterface: BaseFragment):
