...
import com.eazyrento.common.model.modelclass.Customer_detail
import com.eazyrento.common.model.modelclass.OrderListing
import com.eazyrento.common.model.modelclass.Order_listing
import com.eazyrento.common.model.modelclass.Product_detail
...
class OrderListingRepo() {
    ...
    fun getOrdrListing():LiveData<OrderListing> {
        ...
        // hard code value
        val Order_listing: Order_listing =
            Order_listing(
                Customer_detail(
                    "sunil",
                    123,
       ...
       /* val Order_listing2:Order_listing = Order_listing(Customer_detail("sunil",123,"959938")
        ...
        val orderListing =
            OrderListing(ArrayList<Order_listing>())
        var i= 0
        while (i<5){
