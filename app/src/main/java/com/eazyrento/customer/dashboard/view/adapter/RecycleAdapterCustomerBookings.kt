...
class RecycleAdapterCustomerBookings (val bookingDataHolderBinder:BookingDataHolderBinder,val bookingListItem: List<BookingListItem>, val context: Context) : RecyclerView.Adapter<RecycleAdapterCustomerBookings.CardViewHolder>()  {
    ...
    override fun onBindViewHolder(holder: CardViewHolder, position: Int) {
        ...
        bookingDataHolderBinder.setDataHolder(holder,holder.bookingAdapterModel,position)

    }

    class CardViewHolder(view: View):RecyclerView.ViewHolder(view){

        val bookingAdapterModel = BookingAdapterModel(view.tv_booking__name,view.tv_user_type,view.img_booking__pic, view.phone_view,
            view.tv_pro_quantiity,view.tv_show_date,view.tv_customer_order_id,view.tv_status,view.btn_customer_accept,view.btn_customer_decline)
...
interface BookingDataHolderBinder{
    fun setDataHolder(holder: RecycleAdapterCustomerBookings.CardViewHolder, bookingModel: BookingAdapterModel, position: Int)
}